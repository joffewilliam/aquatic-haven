...
- **Generated logo mark**: `public/assets/v7/img/aquatic-haven-logo.png`,
...
| **Prefetch-on-hover** + memoize + `#app` swap + `pushState` (no reload) | `public/assets/v7/app.js` |
...
| Eager product thumbnails with fixed dimensions (no CLS) | `card()` in `server.mjs`, `wakeImages()` in `app.js` |
...
- `public/assets/v7/img/`: 120 free images, generated hero background, and generated logo assets.
